      ...
      <div className="flex-1 min-w-0 overflow-x-hidden flex flex-col min-h-screen">
        ...
        <main className="flex-1 overflow-y-auto px-0">
          <div className="max-w-7xl mx-auto">
            ...
            {/* Row 1: Symbol */}
            <div className="flex flex-wrap items-center gap-2.5" style={{ marginTop: '1.5px' }}>
              <h1 
            ...
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4" style={{ marginTop: '1.5px' }}>
              <div 
