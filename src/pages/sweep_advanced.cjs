...
let out = '';
const file = 'AdvancedReports.tsx';
...
while ((match = classRegex.exec(content)) !== null) {
    ...
    // Look for elements that might need shadows or might have shadows
...
// Remove duplicates if class and style are on the same element (approximate by line number)
const uniqueResults = [];
