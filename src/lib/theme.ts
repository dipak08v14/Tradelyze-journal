export const THEMES = {
  ...
  charcoal: {
    ...
    borderMd: 'rgba(255,255,255,.18)',
    text: '#e8eaf0',
    sub: '#9aa2b0',
    muted: '#9aa2b0',
    bar: 'rgba(255,255,255,.10)',
...
export function applyTheme(themeId: string, accentId: string) {
  const t = THEMES[themeId as keyof typeof THEMES] || THEMES.charcoal;
  ...
  root.style.setProperty('--border-md', t.borderMd || t.border);
